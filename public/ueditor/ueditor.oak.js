...
// 		// console.log(window.top.changes);
// 		that.editor.focus();
// 	};
// }
...
// 			switch (type) {
// 				case "input":
// 					this.inputChange(target, value, i);
// 					break;
// 				case "select":
// 					this.selectChange(target, value, i);
// 					break;
// 				case "timeinput":
// 					this.timeinputChange(target, value, i);
// 					break;
// 				case "checkbox":
// 					this.checkboxChange(target, value, i);
// 					break;
// 				case "radio":
...
// 		}
// 	},
// 	inputChange: function (target, value, key) {
// 		//input控件监听
// 		var that = this;
// 		var oldValue = value;
// 		/* 用定时器监听，节流，优化效率 */
...
// 		});
// 	},
// 	selectChange: function (target, value, key) {
// 		// slect下拉控件监听
// 		var that = this;
// 		var oldValue = value;
